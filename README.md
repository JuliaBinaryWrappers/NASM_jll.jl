# `NASM_jll.jl` (v3.1.0+0)

[![deps](https://juliahub.com/docs/NASM_jll/deps.svg)](https://juliahub.com/ui/Packages/General/NASM_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/385a872afe0ed4810a774d4d0348c28013e69576/N/NASM/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/netwide-assembler/nasm (revision: `746e7c9efa37cec9a44d84a1e96b8c38f385cc1f`)
...
The following JLL packages are required by `NASM_jll.jl`:
